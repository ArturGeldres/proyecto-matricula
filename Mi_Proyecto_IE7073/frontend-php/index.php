...
<head>
    ...
    <style>
        ...
        .hero-banner {
            background: linear-gradient(rgba(27, 67, 50, 0.7), rgba(191, 161, 74, 0.15)), url('img/panel.jpg') no-repeat center/cover;
            min-height: 380px;
            display: flex;
...
<body>
    ...
    <!-- Carrusel Misión, Visión y Valores -->
    <section class="bg-transparent">
        <div class="container section-card">
            <div id="mvvCarousel" class="carousel slide" data-bs-ride="carousel">

                <!-- Indicadores en la parte inferior -->
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#mvvCarousel" data-bs-slide-to="0" class="active"></button>
                    <button type="button" data-bs-target="#mvvCarousel" data-bs-slide-to="1"></button>
                    <button type="button" data-bs-target="#mvvCarousel" data-bs-slide-to="2"></button>
                </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <img src="img/mision.jpg" class="img-fluid rounded shadow" alt="Misión">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <div class="row align-items-center flex-md-row-reverse">
                            ...
                            <div class="col-md-6">
                                <img src="img/vision.jpg" class="img-fluid rounded shadow" alt="Visión">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <img src="img/valores.jpg" class="img-fluid rounded shadow" alt="Valores">
                            </div>
                        </div>
                    </div>
